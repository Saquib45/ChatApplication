...
function ChatPage() {
    ...
    const [messages,setMessages]=useState([{content:"hello",sender:"sakib"},{content:"hi",sender:"sami"},{content:"hi",sender:"sami"},{content:"hi",sender:"sami"},{content:"hi",sender:"sami"},{content:"hi",sender:"sami"}]);
