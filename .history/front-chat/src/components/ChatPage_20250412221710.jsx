            ...
            <main className="py-20 px-10 border w-2/3 dark:bg-slate-600 text-gray-300  mx-auto h-screen overflow-auto">
                {
                    messages.map((message,index)=>(
                        ...
                        <div key={index} className={`flex ${message.sender==current ? 'justify-end' : 'justify-start'}`}>
                            <div  className="my-2.5 bg-blue-600 max-w-xs p-2 rounded">
