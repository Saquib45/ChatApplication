    ...
    return(
        <div className="">
            ...
            <div className="fixed bottom-2 w-full h-10">
                <div className="h-full gap-4 pr-10 flex items-center justify-between  dark:border-gray-600 dark:bg-gray-900 rounded-full w-2/3 mx-auto">
                    ...
                    <button className="dark:bg-green-700  text-gray-300 px-5 pr-0 py-2 hover:dark:bg-green-600 rounded-full">
                        Send 
                    </button>
                </div>
            </div>
