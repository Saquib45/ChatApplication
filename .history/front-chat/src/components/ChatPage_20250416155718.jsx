        ...
        <div className="">
            ...
            <div className="fixed bottom-4 w-full h-12">
                <div className="h-full gap-4 pr-10 flex items-center justify-between  dark:border-gray-600 dark:bg-gray-900 rounded-full w-1/2 mx-auto">
                    ...
                    <button onClick={} className="dark:bg-green-700  text-gray-300 h-10 w-10 flex justify-center items-center hover:dark:bg-green-800 rounded-full">
                        <MdSend size={20}/> 
                    </button>
                    </div>
                </div>
