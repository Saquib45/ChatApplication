        ...
        <div className="">
            ...
            <div className="fixed bottom-2 w-full h-16">
                <div className="h-full gap-4 px-10 flex items-center justify-between  dark:border-gray-600 dark:bg-gray-900 rounded-full w-2/3 mx-auto">
                    <input type="text" placeholder="Type you message here..." className="dark:border-gray-600 p-x w-full border dark:bg-gray-800 rounded-full px-3 py-2 h-full focus:outline-none"/>
