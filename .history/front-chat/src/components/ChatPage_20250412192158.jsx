    ...
    return(
        <div className="">
            ...
            <div className="fixed bottom-2 w-full h-16">
                <div className="h-full border flex dark:border-gray-700 dark:bg-gray-900 rounded w-2/3 mx-auto">
                    <input type="text" placeholder="Type you message here..." className="dark:border-gray-700 dark:bg-gray-900 px-3 py-2 h-full"/>
                    <button className="dark:bg-green-700 flex justify-center items-center text-gray-300 px-3 py-2 hover:dark:bg-green-600 rounded-full">
                        Send Message
                    </button>
                </div>
            </div>
