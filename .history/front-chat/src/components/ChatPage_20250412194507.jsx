        ...
        <div className="">
            ...
            <div className="fixed bottom-4 w-full h-10">
                <div className="h-full gap-4 pr-10 flex items-center justify-between  dark:border-gray-600 dark:bg-gray-900 rounded-full w-1/2 mx-auto">
                    ...
                    <button className="dark:bg-purple-600  text-gray-300 h-10 w-20 hover:purple:bg-green-600 rounded-full">
                        Attach 
                    </button><button className="dark:bg-green-700  text-gray-300 h-10 w-20 hover:dark:bg-green-600 rounded-full">
                        Send 
                    </button>
                    </div>
                </div>
