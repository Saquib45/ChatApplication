...
const JoinCreateChat = () => {
    ...
    const {roomId,userName,connect,setRoomId,setCurrentUser,setConnected}=useChatContext();
    ...
    async function joinChat(){
        if(validateForm()){
            ...
            navigate("/chat");
                    ...
                    if(error.status==404){
                    console.log(error);
                    toast.error("Problem joining the room");       
            }
        ...
        <div className="min-h-screen flex items-center justify-center">
            <div className=" p-10 dark:border-gray-700 border w-full flex  flex-col gap-5 max-w-md rounded dark:bg-gray-900 shadow">
                ...
                <div>
                    ...
                    <input  type="text" name='userName' onChange={handleFormInputChange} value={detail.userName} placeholder="Enter The Name" 
                        id="name"
