...
<div className="fixed bottom-4 w-full px-4">
  <div className="h-full gap-4 flex items-center justify-between dark:border-gray-600 dark:bg-gray-900 rounded-full max-w-3xl mx-auto px-4 py-2">
    <input
      type="text"
      placeholder="Type your message here..."
      className="dark:border-gray-600 flex-grow border dark:bg-gray-800 rounded-full px-5 py-2 focus:outline-none"
    />
    <div className="flex gap-2 ml-2">
      <button className="dark:bg-purple-600 text-gray-300 h-10 px-4 hover:dark:bg-purple-700 rounded-full">
        Attach
      </button>
      <button className="dark:bg-green-700 text-gray-300 h-10 px-4 hover:dark:bg-green-800 rounded-full">
        Send
      </button>
    </div>
  </div>
